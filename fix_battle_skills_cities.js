/**
 * Project: CityCard
 * File: fix_battle_skills_cities.js
 * Description: 修复 battleSkills.js 中的城市访问方式, 从数组方法改为对象方法
 *
...
const skillFile = path.join(__dirname, 'src/composables/skills/battleSkills.js')
...
console.log('✅ battleSkills.js 已修复')
